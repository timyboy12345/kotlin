...
import org.jetbrains.kotlin.parcelize.ParcelizeAnnotationChecker.Companion.TYPE_PARCELER_FQNAME
...
internal fun getTypeParcelers(annotations: Annotations): List<TypeParcelerMapping> {
    ...
    for (annotation in annotations.filter { it.fqName == TYPE_PARCELER_FQNAME }) {
