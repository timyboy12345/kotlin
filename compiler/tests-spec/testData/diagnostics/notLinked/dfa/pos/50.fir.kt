...
fun Any.case_2() {
    if (this is ClassWithSixTypeParameters<*, *, *, *, *, *>) {
        ...
        <!DEBUG_INFO_EXPRESSION_TYPE("CapturedType(*)")!>y<!>
    }
}
...
fun <T> Inv<out T>.case_7() {
    if (this.prop_3 is MutableList<*>) {
        this.prop_3
        this.prop_3[0]
        <!DEBUG_INFO_EXPRESSION_TYPE("kotlin.collections.MutableList<*> & CapturedType(out T)!! & CapturedType(out T)")!>prop_3<!>
        <!DEBUG_INFO_EXPRESSION_TYPE("kotlin.collections.MutableList<*> & CapturedType(out T)!! & CapturedType(out T)")!>prop_3<!>[0]
    }
}
