...
fun case_2(a: Out<out Out<out Out<out Out<out Out<out Out<out Int?>?>?>?>?>?>?) {
    if (a != null) {
        ...
        if (b != null) {
            val c = <!DEBUG_INFO_EXPRESSION_TYPE("CapturedType(out Out<out Out<out Out<out Out<out Out<out kotlin.Int?>?>?>?>?>?)!! & CapturedType(out Out<out Out<out Out<out Out<out Out<out kotlin.Int?>?>?>?>?>?)")!>b<!>.get()
            if (c != null) {
                val d = <!DEBUG_INFO_EXPRESSION_TYPE("CapturedType(out Out<out Out<out Out<out Out<out kotlin.Int?>?>?>?>?)!! & CapturedType(out Out<out Out<out Out<out Out<out kotlin.Int?>?>?>?>?)")!>c<!>.get()
                if (d != null) {
                    val e = <!DEBUG_INFO_EXPRESSION_TYPE("CapturedType(out Out<out Out<out Out<out kotlin.Int?>?>?>?)!! & CapturedType(out Out<out Out<out Out<out kotlin.Int?>?>?>?)")!>d<!>.get()
                    if (e != null) {
                        val f = <!DEBUG_INFO_EXPRESSION_TYPE("CapturedType(out Out<out Out<out kotlin.Int?>?>?)!! & CapturedType(out Out<out Out<out kotlin.Int?>?>?)")!>e<!>.get()
                        if (f != null) {
                            val g = <!DEBUG_INFO_EXPRESSION_TYPE("CapturedType(out Out<out kotlin.Int?>?)!! & CapturedType(out Out<out kotlin.Int?>?)")!>f<!>.get()
                            if (g != null) {
                                <!DEBUG_INFO_EXPRESSION_TYPE("CapturedType(out kotlin.Int?)!! & CapturedType(out kotlin.Int?)")!>g<!>
                                <!DEBUG_INFO_EXPRESSION_TYPE("CapturedType(out kotlin.Int?)!! & CapturedType(out kotlin.Int?)")!>g<!>.equals(null)
                                <!DEBUG_INFO_EXPRESSION_TYPE("CapturedType(out kotlin.Int?)!! & CapturedType(out kotlin.Int?)")!>g<!>.propT
                                <!DEBUG_INFO_EXPRESSION_TYPE("CapturedType(out kotlin.Int?)!! & CapturedType(out kotlin.Int?)")!>g<!>.propAny
                                <!DEBUG_INFO_EXPRESSION_TYPE("CapturedType(out kotlin.Int?)!! & CapturedType(out kotlin.Int?)")!>g<!>.propNullableT
                                <!DEBUG_INFO_EXPRESSION_TYPE("CapturedType(out kotlin.Int?)!! & CapturedType(out kotlin.Int?)")!>g<!>.propNullableAny
                                <!DEBUG_INFO_EXPRESSION_TYPE("CapturedType(out kotlin.Int?)!! & CapturedType(out kotlin.Int?)")!>g<!>.funT()
                                <!DEBUG_INFO_EXPRESSION_TYPE("CapturedType(out kotlin.Int?)!! & CapturedType(out kotlin.Int?)")!>g<!>.funAny()
                                <!DEBUG_INFO_EXPRESSION_TYPE("CapturedType(out kotlin.Int?)!! & CapturedType(out kotlin.Int?)")!>g<!>.funNullableT()
                                <!DEBUG_INFO_EXPRESSION_TYPE("CapturedType(out kotlin.Int?)!! & CapturedType(out kotlin.Int?)")!>g<!>.funNullableAny()
                            }
                        }
                    }
                }
...
fun case_17(a: Inv<out Out<Out<Out<Out<Out<Int?>?>?>?>?>?>?) {
    if (a != null) {
        ...
        if (b != null) {
            val c = <!DEBUG_INFO_EXPRESSION_TYPE("CapturedType(out Out<Out<Out<Out<Out<kotlin.Int?>?>?>?>?>?)!! & CapturedType(out Out<Out<Out<Out<Out<kotlin.Int?>?>?>?>?>?)")!>b<!>.get()
            if (c != null) {
